...
- Phase 03-02 (docs-gap-closure CI verification): Confirmed deploy-docs.yml validity (actions/setup-node@v6 confirmed), identified GitHub Pages enablement as deploy prerequisite, closing all 6 audit gaps from the v1.1.0 milestone audit
...
[Unreleased]: https://github.com/LeVarez/vit-cc/compare/v1.1.0...HEAD
[1.1]: https://github.com/LeVarez/vit-cc/compare/v1.0.0...v1.1.0
[1.0]: https://github.com/LeVarez/vit-cc/releases/tag/v1.0.0
