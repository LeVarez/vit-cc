...
<required_reading>
@./.claude/vit/references/verification-patterns.md
@./.claude/vit/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the vit-verifier agent -->
</step>
...
See ./.claude/vit/templates/verification-report.md for complete template.
</step>
