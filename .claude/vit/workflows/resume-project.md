...
<required_reading>
@./.claude/vit/references/continuation-format.md
</required_reading>
...
**If .planning/ doesn't exist:** This is a new project - route to /vit:new-project
</step>
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/vit:execute-phase {phase})
   OR
1. Discuss Phase 3 context (/vit:discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/vit:plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/vit:discuss-phase [N]` — gather context first
  - `/vit:research-phase [N]` — investigate unknowns
