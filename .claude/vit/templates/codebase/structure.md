...
**New Slash Command:**
- Primary code: `commands/vit/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `vit/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `vit/workflows/{name}.md`
- Usage: Reference from command with `@./.claude/vit/workflows/{name}.md`

**New Reference Document:**
- Implementation: `vit/references/{name}.md`
