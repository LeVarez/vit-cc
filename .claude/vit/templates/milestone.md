...
```markdown
## v[X.Y.Z] [Name] (Shipped: YYYY-MM-DD)
...
- Initial v1.0.0 MVP shipped
- Major version releases (v2.0.0, v3.0.0)
- Significant feature milestones (v1.1.0, v1.2.0)
...
## v1.1.0 Security & Polish (Shipped: 2025-12-10)
...
- 8 days from v1.0.0 to v1.1.0

**Git range:** `feat(05-01)` → `feat(06-02)`

**What's next:** v2.0.0 SwiftUI redesign with widget support

---

## v1.0.0 MVP (Shipped: 2025-11-25)
...
**What's next:** Security audit and hardening for v1.1.0
```
</example>
