...
| Phase | Feature Issue | Branch | Sub-issues | Plan Branches |
|-------|---------------|--------|------------|---------------|
| ${MILESTONE}/{X} | #[FEATURE_ISSUE] | [BASE_BRANCH] | #[01-issue], #[02-issue] | feature/v${MILESTONE}-${PHASE_NUM}-01-[slug], feature/v${MILESTONE}-${PHASE_NUM}-02-[slug] |
```
