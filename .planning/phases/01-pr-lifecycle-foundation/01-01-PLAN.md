...
- execute-phase step 0.7 creates draft PR before plan discovery; checks gh availability, guards against duplicates via live `gh pr list --head`, assembles body from ROADMAP.md + PLAN.md files, targets `milestone/vX.Y.Z`, records pr#N in STATE.md immediately on success
