...
must_haves:
  truths:
    - "Running execute-phase creates a draft PR targeting milestone/vX.Y with phase goal, plans checklist, success criteria, and Closes #N in the body"
...
5. PR base branch is always `milestone/vX.Y`
...
- PR targets milestone/vX.Y, never main
