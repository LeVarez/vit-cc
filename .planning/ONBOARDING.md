...
2. `.planning/REQUIREMENTS.md` — what v1.1 must deliver (27 requirements)
...
| `feature/v1.1-01-readme-rewrite` | Phase 01 — README rewrite |
| `feature/v1.1-02-docs-site` | Phase 02 — VitePress docs site |

To start working on a phase:
```bash
git checkout feature/v1.1-01-readme-rewrite
# or if using worktrees:
cd ../vit-cc-feature-v1.1-01-readme-rewrite
```
