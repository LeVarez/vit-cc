...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /vit:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ./.claude/vit/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ./.claude/vit/templates/discovery.md structure:
...
1. **Scope the discovery** using ./.claude/vit/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ./.claude/vit/templates/discovery.md
...
Use ./.claude/vit/templates/discovery.md.
...
1. Discuss phase context (/vit:discuss-phase [current-phase])
2. Create phase plan (/vit:plan-phase [current-phase])
