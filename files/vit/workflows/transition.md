...
Exit skill and invoke SlashCommand("/vit:plan-phase [X+1]")
...
**Also available:**
- `/vit:discuss-phase [X+1]` — gather context first
- `/vit:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/vit:complete-milestone {version}")
