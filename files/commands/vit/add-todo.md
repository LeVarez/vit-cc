...
<objective>
Capture an idea, task, or issue that surfaces during a VIT session as a structured todo for later work.
...
- `/vit:add-todo Add auth token refresh` → title = "Add auth token refresh"
...
2. Add another todo
3. View all todos (/vit:check-todos)
```
</step>
