---
name: set-profile
description: Switch model profile for VIT agents (quality/balanced/budget)
arguments:
  - name: profile
...
<objective>
Switch the model profile used by VIT agents. This controls which Claude model each agent uses, balancing quality vs token spend.
</objective>
...
```
Error: No VIT project found.
Run /vit:new-project first to initialize a project.
```
